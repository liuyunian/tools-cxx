...
std::string Timestamp::to_string() const {
    ...
    int64_t seconds = m_microsecondsSinceEpoch / k_microsecondsPerSecond;
    int64_t microseconds = m_microsecondsSinceEpoch % k_microsecondsPerSecond;
...
Timestamp Timestamp::now(){
    ...
    return Timestamp(seconds * k_microsecondsPerSecond + tv.tv_usec);
}